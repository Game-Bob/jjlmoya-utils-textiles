...
const UTILITY_ASSET_ROOT = "/_utilities/textiles";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/textiles/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/textiles/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("textiles");
